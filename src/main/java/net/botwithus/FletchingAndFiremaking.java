...
public class FletchingAndFiremaking extends LoopingScript {
    ...
    public FletchingAndFiremaking(String s, ScriptConfig scriptConfig, ScriptDefinition scriptDefinition) {
