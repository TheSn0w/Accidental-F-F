...
public class SkeletonScriptGraphicsContext extends ScriptGraphicsContext {
    ...
    public void drawSettings() {
        ...
        if (ImGui.Begin("Snows Accidental F&F", 0)) {
            ...
            if (ImGui.Checkbox("Eggspreimentation", currentDinosaurPropellantOption)) {
            ...
            if (ImGui.Checkbox("Seggregation", currentSharpShellsOption)) {
            ...
            ImGui.Text("Current Firemaking Level: " + currentLevel + "  (" + levelsGained + " Gained)");
